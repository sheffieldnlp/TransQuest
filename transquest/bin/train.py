...
def main():
    ...
    train_data = train_set.make_dataset(args.train_path, features_path='{}.train.tsv'.format(args.features_pref))
    test_data = test_set.make_dataset(args.test_path, features_path='{}.test.tsv'.format(args.features_pref))
    test_tsv = test_set.read(args.test_path, features_path='{}.test.tsv'.format(args.features_pref))
