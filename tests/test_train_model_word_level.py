...
class TestTrain(unittest.TestCase):
    ...
    def test_trains_model_word_level(self):
        ...
        dataset.make_dataset(w.src_txt, w.src_tags_txt, w.mt_txt, w.mt_tags_txt, wmt_format=True, with_gaps=False)
    ...
    def test_trains_model_word_level_with_features(self):
        ...
        dataset.make_dataset(
            w.src_txt, w.tgt_txt, w.tags_txt, features_path=[w.features_path], raw_mt_path=w.mt_path, wmt_format=True
        )
        train_model(dataset.tensor_dataset, config, test_size=0.5)
